...
Яндекс Карты — мобильное приложение, позваоляющее производить поиск по карте, информация о пробках, отслеживание городского транспорта, прокладка маршрутов и панорамы улиц крупных и других городов.

<a name="differences_from_analogues"/>

## 1.4 Отличия от аналогов
В отличие от приложения "Moovit", в разрабатываемом приложение будет возможность ориентироваться по встроенной карте, а не только выбирать на ней адреса, между которыми происходит движение. С сервисом Яндекса тяжело соперничать, так как он предлогает намного более широкий набор возможностей.
...
| Функция | Требования | 
|:---|:---|
| Найти маршрут | Прокладывать несколько маршрутов. Предоставить возможность выбрать предпочитаемый вид транспорта. При необходимости сохранить маршрут. Показывать на маршрутах время движения тем или иным образом (пешком, на автобусе и т.д.) |
| Выбор началного и конечного адреса | Возможность выбора конечного и начального пункта движения как на карте, так и в письменном формате. Сохранять при необходимости адрес |
| Движение по выбранному маршруту | Приложение будет в реальном времени следить за движением пользователя по маршруту. Ориентировать пользователя на протяжении всего движения по выбранному маршруту (напоминать об выходе на остановках). Функция должна работать в фоновом режиме. При необходимости пользовател может закончить отслеживание движения по маршруту раньше времени |

<a name="navigation_on_map"/>

#### 3.1.1.2 Навигация на карте
**Описание.** Пользователь будет иметь возможность ориентироваться на карте с использованием данных о местоположении телефона. На карте будут отображаться остановки общественнго транспорта.
 
| Функция | Требования | 
|:---|:---|
| Просмотреть информацию об остановке | Показать пользователю информацию об времени прибытия общественного транспорта на данной остановке. Показывать на карте движения ближайшего траноспорта |
...
| Поиск маршрута | Пользователь может ввести номер и понем найти необходимый маршрут |
| Выбрать нужный вид транспорта | Пользователь может перемещаться по категориям в зависимотси от нужного вида транспорта |
| Уведомлять пользователя при изменения в расписании | Пользователь будет получать информацию об изменениях в расписании |

<a name="settings"/>

#### 3.1.1.4 Настройки
**Описание.** Пользователь может настроить приложение в соответсвующей вклдаке.

| Функция | Требования | 
|:---|:---|
| Оплата подписки | Пользователь имеет возможность оплатить подписку, что-бы поддержать разработчкиа и отключить рекламу |
...
| Уведомления | Отключение или включение всплывающих уведомлений об изменениях в раписании общественного трнаспорта |

<a name="restrictions_and_exclusions"/>

### 3.1.2 Ограничения и исключения
1. Приложение работает только при наличии подключения к Интернету;
2. При отсутсвии доступа к данным местоположения телефона, пользователь сможет просматривать только расписание общественного транспорта. 
...
Приложение не собирает личную информацию об пользователе, кроме возможности задания домашнего адреса. Однако иной информации о пользователе не будет, поэтому соотнеести ее с конкретным человком нельзя. Оплата подписки производиться через надежный сервис Google Play.
