...
| Выбрать нужный вид транспорта | Пользователь может перемещаться по категориям в зависимотси от нужного вида транспорта. Для избранного будет отдельная категория |
